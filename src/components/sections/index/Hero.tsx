      ...
      <section className="max-w-4xl w-full flex flex-col mx-auto pt-44">
        ...
        >
          ...
          <p className="font-semibold lg:text-3xl md:text-2xl sm:text-xl text-lg">
            {inView &&
              <Typewriter
                options={{
                  delay: 30,
                  strings: ["I am a 17 year old full-stack developer based in Dubai"],
                  loop: false,
                  autoStart: true,
          ...
          <ul className="flex flex-row flex-wrap gap-2 mt-2">
            ...
            />
            <SocialIcon
              url="https://www.linkedin.com/in/arsany-tharwat-1153632a3/"
            ...
            />
            <SocialIcon
              url="https://www.youtube.com/@arraypvp"
