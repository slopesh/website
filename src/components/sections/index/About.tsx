    ...
    },
    {
      ...
      icon: (
        <img
          ...
          draggable={false}
          className="h-6"
          src="https://r2.e-z.host/2082d908-7c65-4fc3-b02a-5f50f9141543/zkji5ma1.png"
        />
      ),
      link: "https://gsap.com/",
    },
    ...
    },
    {
      ...
      icon: (
        <img
          ...
          draggable={false}
          className="h-6"
          src="https://r2.e-z.host/2082d908-7c65-4fc3-b02a-5f50f9141543/9aivscb1.png"
        />
      ),
    ...
    },
    {
      ...
      icon: (
        <img
          ...
          draggable={false}
          className="h-6"
          src="https://r2.e-z.host/2082d908-7c65-4fc3-b02a-5f50f9141543/92tzzi14.png"
        />
      ),
    ...
    <>
      <section id="about" className="max-w-4xl w-full flex flex-col mx-auto">
        ...
        <ul className="grid grid-cols-2 gap-4 mt-4">
          <AboutCard
            title="Overall"
            description="Hello! I'm Arrays, a 17-year-old Full Stack Developer with almost 4 years of practical experience in a variety of tech stacks. My areas of expertise are developing scalable apps, experimenting with backend systems, and designing seamless frontend user interfaces. I've also been involved in the technical Minecraft scene since 2018, working on everything from community tools and automation systems."
            direction="top"
            span={2}
            delay={0.1}
          ...
          <AboutCard
            title="Backend"
            description="I work with various backend technologies to build robust APIs and server-side applications with focus on performance."
            tech={backendTech}
            direction="right"
            span={1}
            delay={0.2}
